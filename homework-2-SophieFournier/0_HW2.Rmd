...
Name <- c("James", "Olivia", "Stella", "Mathew")
Gender <- c("M", "F", "F", "M")
q2 <- StringNumObject <- data.frame(Age, Name, Gender)
StringNumObject #Your final answer - should produce the final table
# END SOLUTION
```
...
sum(is.na(q3))
q3 <- sum(is.na(q3)) #Your final answer
# END SOLUTION
```
...
q6 <- c(which(sapply(x, function(x) "3" %in% x)), which(sapply(x, function(x) "7" %in% x))) #Your final answer
# END SOLUTION
```
...
sum(unlist(a))
q7 <- sum(unlist(a)) #Your final answer
# END SOLUTION
```
...
z = "NewItem"
append(x, z)
q8 <- append(x, z) #Your final answer
# END SOLUTION
```
...
q9 <- q9.function <- function(x) x * 2.54 #Your final answer
# END SOLUTION
```
...
sum(less4Vd < 4)
q10 <- c((length(totalInd)), (sum(totalVd)), (sum(less4Vd < 4))) ##Your final answer
# END SOLUTION
```
...
q11.1 <- (df1$Gender01 = ifelse(df1$Gender == "M", "0" , "1"))
df1 ##Your final answer
q11.2 <- (for (i in 1:4){
  if (df1$Gender[i] == "M"){
    (df1$Gender01[i] <- c("0"))}
  if (df1$Gender[i] == "F"){
...
```{r}
# BEGIN SOLUTION
q12.2 <- "https://github.com/SophieFournier/sfournier22" ##paste your link here (as a string that must include the pattern github.com)
# END SOLUTION
```
...
```{r}
# BEGIN SOLUTION
q12.3 <- "https://github.com/SophieFournier-DM523" ##paste your link here (as a string that must include the pattern github.com)
# END SOLUTION
```
...
```{r}
# BEGIN SOLUTION
q12.4 <- "https://github.com/SophieFournier-DM523/sfournier22" ##paste your link here (as a string that must include the pattern github.com)
# END SOLUTION
```
...
```{r}
# BEGIN SOLUTION
q12.5 <- "https://github.com/SophieFournier-DM523/sfournier22/blob/main/Intro-master/code/01-Reshape.R" ##paste your link here (as a string that must include the pattern github.com)
# END SOLUTION
```
...
```{r}
# BEGIN SOLUTION
q12.6 <- "https://github.com/SophieFournier/sfournier22/pull/1" ##paste your link here (as a string that must include the pattern github.com)
# END SOLUTION
```
